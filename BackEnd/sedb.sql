...
-- Table `sedb`.`history`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `sedb`.`history`;

CREATE TABLE IF NOT EXISTS `sedb`.`history`
(
    `userId`      INT      NOT NULL,
    `commodityId` INT      NOT NULL,
    `number`      INT      NOT NULL,
...
-- Table `sedb`.`group`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `sedb`.`group`;
...
-- -----------------------------------------------------
-- Table `sedb`.`groupinformation`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `sedb`.`groupinformation`;

CREATE TABLE IF NOT EXISTS `sedb`.`groupinformation`
(
    ...
    CONSTRAINT `groupInfo_id`
        FOREIGN KEY (`groupId`)
            REFERENCES `sedb`.`group` (`groupId`)
            ON DELETE NO ACTION
            ON UPDATE NO ACTION,
    CONSTRAINT `groupInfo_sender`
        FOREIGN KEY (`senderId`)
            REFERENCES `sedb`.`user` (`id`)
            ON DELETE NO ACTION
            ON UPDATE NO ACTION
...
-- -----------------------------------------------------
-- Table `sedb`.`groupmember`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `sedb`.`groupmember`;

CREATE TABLE IF NOT EXISTS `sedb`.`groupmember`
(
    `groupId`    INT      NOT NULL,
    `userId`     INT      NOT NULL,
    `updateTime` DATETIME NOT NULL,
    CONSTRAINT `groupMember_groupID`
        FOREIGN KEY (`groupId`)
            REFERENCES `sedb`.`group` (`groupId`)
            ON DELETE NO ACTION
            ON UPDATE NO ACTION,
    CONSTRAINT `groupMember_userId`
        FOREIGN KEY (`userId`)
            REFERENCES `sedb`.`user` (`id`)
            ON DELETE NO ACTION
            ON UPDATE NO ACTION
...
-- Table `sedb`.`friend`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `sedb`.`friend`;

CREATE TABLE IF NOT EXISTS `sedb`.`friend`
(
    `user1` INT NOT NULL,
    `user2` INT NOT NULL,
    `state` INT NOT NULL,
    PRIMARY KEY (`user1`, `user2`),
    CONSTRAINT `friend_user1`
        FOREIGN KEY (`user1`)
            REFERENCES `sedb`.`user` (`id`)
            ON DELETE NO ACTION
            ON UPDATE NO ACTION,
    CONSTRAINT `friend_user2`
        FOREIGN KEY (`user2`)
            REFERENCES `sedb`.`user` (`id`)
            ON DELETE NO ACTION
            ON UPDATE NO ACTION
